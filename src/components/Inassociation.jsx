    ...
    <div className="md:my-7 overflow-hidden relative">
      ...
      <div className="relative ">
        <button
          ...
          className="absolute top-1/2 left-4 md:left-14 transform -translate-y-1/2 bg-white p-2 rounded-full shadow-md z-10 border border-gray-300"
          disabled={currentIndex === 0}
          style={{ marginLeft: '0px' }} // Adjust margin to bring button closer
        >
        ...
        <button
          onClick={handleNext}
          className="absolute top-1/2 right-4 md:right-14 transform -translate-y-1/2 bg-white p-2 rounded-full shadow-md z-10 border border-gray-300"
          disabled={currentIndex >= totalItems - itemsPerView}
           // Adjust margin to bring button closer
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6 text-gray-700">
